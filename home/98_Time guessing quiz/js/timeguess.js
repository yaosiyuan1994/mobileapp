...
stop.addEventListener("click", function () {
  ...
  soundControl(
    timer.textContent.substring(0, 5) === "00:10" ? editSound[2] : editSound[1]
  );
  if (timer.textContent.substring(0, 5) === "00:10") {
    fireWork[0].style.backgroundImage = "url('img/fireworks.gif')";
    fireWork[0].style.backgroundColor = "rgba(0,0,0,0)";
  }
});
...
reset.addEventListener("click", function () {
  ...
  stopTime = 0;
  soundControl(editSound[3]);
  fireWork[0].style.backgroundImage = "";
  fireWork[0].style.backgroundColor = "rgba(233, 168, 227, 0.6)";
});
